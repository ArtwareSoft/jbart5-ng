System.register(['jb-core', 'jb-ui', 'jb-ui/jb-rx', './studio-tgp-model'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            jb_core_1.jb.component('material-demo.pick', {
                type: 'action',
                params: [
            ...
            jb_core_1.jb.component('dialog.material-demo-pick-dialog', {
                hidden: true,
                type: 'dialog.style',
                params: [
                    { id: 'from', as: 'string' },
            ...
            jb_core_1.jb.component('dialog-feature.material-demo-pick', {
                type: 'dialog-feature',
                params: [],
                impl: function (ctx) {
                    return ({
                        init: function (cmp) {
                            var previewOffset = $('#jb-preview').offset().top;
                            0;
