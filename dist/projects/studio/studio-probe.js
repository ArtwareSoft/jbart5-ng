System.register(['jb-core', './studio-model', 'jb-ui/jb-rx'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            jb_core_1.jb.component('studio.start-probe', {
                type: 'data',
                ...
                impl: function (context, path) {
                    ...
                    jb_core_1.jb.bind(context.vars.$dialog, 'close', function () {
            ...
            jb_core_1.jb.component('studio.context-view', {
                type: 'control',
                impl: { $: 'label', title: { $: 'studio.contextToString' } }
            });
            jb_core_1.jb.component('studio.output-view', {
                type: 'control',
                params: {
                    path: { as: 'string' },
                    ctx: { as: 'single' },
            ...
            jb_core_1.jb.component('studio.output-comp', {
                type: 'control',
                params: {
                    toShow: { as: 'single' },
                },
            ...
            jb_core_1.jb.component('studio.contextToString', {
                type: 'data',
            ...
            jb_core_1.jb.component('studio.compToString', {
                type: 'data',
                impl: function (context) {
                    ...
                    return [
                        ...
                        JSON.stringify(jb_core_1.jb.extend({}, annotations.host))
                    ].join('\n');
                }
            });
        }
