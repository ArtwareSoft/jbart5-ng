System.register(['js/jb'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            jb_1.jb.component('studio.pickAndOpen', {
                type: 'action',
                params: {
            ...
            jb_1.jb.component('studio.toolbar', {
                type: 'control',
                impl: { $: 'group',
            ...
            jb_1.jb.component('studio_button.toolbarButton', {
                type: 'button.style',
                params: {
            ...
            jb_1.jb.component('studio.redraw', {
                type: 'action',
...
//# sourceMappingURL=studio-toolbar.js.map