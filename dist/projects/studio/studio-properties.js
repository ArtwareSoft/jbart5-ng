System.register(['js/jb', './studio-model'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            jb_1.jb.component('studio.openProperties', {
                type: 'action',
                impl: { $: 'openDialog',
                    title: [
                        { $: 'object',
            ...
            jb_1.jb.component('studio.openNewCtrlDialog', {
                type: 'action',
                impl: { $: 'openDialog',
                    modal: true,
                    title: 'New Control',
                    ...
                    onOK: [
                        function (ctx) { return studio.modifyOperationsEm.take(1)
                            .subscribe(function (e) {
                            return ctx.run({ $runActions: [
                                    { $: 'writeValue',
            ...
            jb_1.jb.component('studio.openSourceDialog', {
                type: 'action',
                impl: { $: 'openDialog',
                    modal: true,
                    title: 'Source',
            ...
            jb_1.jb.component('studio.properties', {
                type: 'control',
            ...
            jb_1.jb.component('studio.propertyField-Label', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'label',
            ...
            jb_1.jb.component('studio.propertyField-Primitive', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'group',
            ...
            jb_1.jb.component('studio.propertyField-Enum', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'picklist',
                    title: { $: 'studio.prop-name', path: '%$path%' },
            ...
            jb_1.jb.component('studio.propertyField-TgpType', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'group',
                    title: { $: 'studio.prop-name', path: '%$path%' },
            ...
            jb_1.jb.component('studio.propertyField-Style', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'group',
                    title: { $: 'studio.prop-name', path: '%$path%' },
            ...
            jb_1.jb.component('studio.propertyField-JBEditor', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'group',
                    title: { $: 'studio.prop-name', path: '%$path%' },
            ...
            jb_1.jb.component('studio.propertyField-Javascript', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'group',
                    title: { $: 'studio.prop-name', path: '%$path%' },
            ...
            jb_1.jb.component('studio.propertyField-Array', {
                type: 'control',
                params: { path: { as: 'string' } },
                impl: { $: 'group',
                    title: { $: 'studio.prop-name', path: '%$path%' },
            ...
            jb_1.jb.component('studio.openPrimitiveArrowPopup', {
                type: 'action',
                params: {
                    path: { as: 'string' },
            ...
            jb_1.jb.component('studio.propertyField', {
                type: 'control',
                params: {
                    path: { as: 'string' },
                },
            ...
            // ********************* styles **********************
            jb_1.jb.component('tabControl.studioPropertiesAccordion', {
            ...
            jb_1.jb.component('expandableSection.studioExpandableInArray', {
            ...
            jb_1.jb.component('property-sheet.studio-properties', {
                type: 'group.style',
                impl: { $: 'customStyle',
            ...
            jb_1.jb.component('button.studio-edit-js', {
                type: 'button.style',
                impl: { $: 'customStyle',
            ...
            jb_1.jb.component('button.studio-delete', {
                type: 'button.style',
                impl: { $: 'customStyle',
                    template: '<span><button (click)="clicked()" [title]="title">&#215;</button></span>',
            ...
            jb_1.jb.component('studio.tgp-path-options', {
            ...
            jb_1.jb.component('studio.tgp-type-options', {
            ...
            jb_1.jb.component('group.studio-watch-path', {
                type: 'feature',
                params: {
...
//# sourceMappingURL=studio-properties.js.map