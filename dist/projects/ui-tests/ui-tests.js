jbLoadModules(['jb-core']).then(function (loadedModules) {
    ...
    jb.resource('ui-tests', 'wait5sec', new Promise(function (res) { return setTimeout(function () { res(5); }, 5000); }));
    jb.resource('ui-tests', 'wait2sec', new Promise(function (res) { return setTimeout(function () { res(2); }, 2000); }));
    ...
    jb.component('ui-test.http-get', {
        impl: { $: 'ng2-ui-test', disableChangeDetection1: false,
            control: { $: 'group',
                controls: { $: 'itemlist',
                    items: '%$peopleFromUrl%',
                    controls: { $: 'group',
    ...
    jb.component('ui-test.group.accordion', {
        impl: { $: 'ng2-ui-test', disbleChangeDetection: false,
            control: { $: 'group',
