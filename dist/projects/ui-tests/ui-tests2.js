        ...
        execute: function() {
            ...
            jb_core_1.jb.component('ui-test.prettyPrintComp', {
                ...
                impl: { $: 'ng2-ui-test', waitForPromise: { $delay: 50 },
                    control: { $: 'group', controls: [
                            { $: 'text',
                                text: function (ctx) { return jb_core_1.jb.prettyPrintComp('inner-label1-tst', jbart.comps['inner-label1-tst']); },
                                style: { $: 'text.multi-line' }
                            },
                            { $: 'text',
                                text: function (ctx) { return jb_core_1.jb.prettyPrintComp('editable-text.codemirror', jbart.comps['editable-text.codemirror']); },
