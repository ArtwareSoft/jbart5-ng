    ...
    return {
        ...
        execute: function() {
            jb_1.jb.component('label', {
                ...
                impl: function (ctx) {
                    return jb_ui.ctrl(ctx.setVars({ title: jb_1.jb.val(ctx.params.title) }));
                }
            });
            jb_1.jb.type('label.style');
            jb_1.jb.component('label.span', {
                type: 'label.style',
                impl: { $: 'customStyle',
            ...
            jb_1.jb.component('label.static-span', {
                type: 'label.style',
                impl: { $: 'customStyle',
                    template: '<span>%$title%</span>'
                }
            });
            jb_1.jb.component('label.h1', {
                type: 'label.style',
                impl: { $: 'customStyle',
