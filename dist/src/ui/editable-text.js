System.register(['js/jb', 'ui/jb-ui', 'ui/jb-rx'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            jb_1.jb.type('editable-text.style');
            jb_1.jb.component('editable-text', {
                type: 'control',
                params: {
                ...
                impl: function (ctx) { return jb_ui.ctrl(ctx.setVars({ field: jb_ui.twoWayBind(ctx.params.databind) })); }
            });
            jb_1.jb.component('editable-text.bindField', {
                type: 'feature',
                impl: function (ctx) { return jb_1.jb.obj('init', function (cmp) { return ctx.vars.field.bindToCmp(cmp, ctx); }); }
            });
            jb_1.jb.component('editable-text.input', {
            ...
            jb_1.jb.component('editable-text.textarea', {
            ...
            jb_1.jb.component('editable-text.codemirror', {
                type: 'editableText.style',
                params: {
                        ...
                        init: function (cmp) {
                            ...
                            context.vars.ngZone.runOutsideAngular(function () {
                                ...
                                editorTextChange.distinctUntilChanged()
                                    ...
                                    .subscribe(function (x) { field.writeValue(x); jb_ui.apply(context); });
